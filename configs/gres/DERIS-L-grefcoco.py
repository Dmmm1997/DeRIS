...
val_pipeline = [
    ...
    dict(
        type="CollectData",
        keys=["img", "img_mini", "ref_expr_inds", "text_attention_mask", "gt_mask_rle", "gt_bbox", "gt_mask_parts_rle"],
        meta_keys=[
            "filename",
            "expression",
            "ori_shape",
...
model = dict(
    ...
    perception_branch=dict(
        ...
        mask_config="deris/models/branchs/perception_branch/mask_config/maskformer2_swin_base_384_bs16_50ep.yaml",
        hidden_size=256,
        num_queries=num_query,
        pretrain_weights="pretrain_weights/model_final_f6e0f6.pkl",
    ...
    visualize_params={"enable": False, "row_columns": (4, 5), "train_interval": 50, "val_interval": 5},
)
